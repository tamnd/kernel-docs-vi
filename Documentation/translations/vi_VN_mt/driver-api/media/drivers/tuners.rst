...
:Original: Documentation/driver-api/media/drivers/tuners.rst
...
- L= LG_API (VHF_LO=0x01, VHF_HI=0x02, UHF=0x08, đài=0x04)
- P= PHILIPS_API (VHF_LO=0xA0, VHF_HI=0x90, UHF=0x30, đài=0x04)
...
Các Bộ điều chỉnh này tương thích với PHILIPS_API.

Nhận dạng Bộ điều chỉnh Philips: (ví dụ: FM1216MF)
...
Nhận dạng Temia Tuner: (.e.g 4006FH5)
...
- TADC-M201D: PAL D/K+B/G+I (L,143/425) (điều khiển âm thanh tại địa chỉ I2C 0xc8)
- TADC-T003F: NTSC Đài Loan (L,175/410?; 2-B, C-W+11, W+12-69)

Hậu tố:
  - P= Ổ cắm phono cái tiêu chuẩn
  - Ổ cắm cái D= IEC
  - F= đầu nối F
...
- Hầu hết đều tương thích với LG_API
- TSCH6 có ALPS_API (TSCH5?)
- TSBE1 có thêm API 05,02,08 Control_byte=0xCB Nguồn:[#f1]_
