...
:Original: Documentation/userspace-api/media/mediactl/media-types.rst
...
Các loại và cờ được sử dụng để thể hiện các thành phần biểu đồ đa phương tiện
=============================================================================
...
Một và duy nhất một trong ZZ0000ZZ và ZZ0001ZZ
phải được thiết lập cho mỗi pad.
