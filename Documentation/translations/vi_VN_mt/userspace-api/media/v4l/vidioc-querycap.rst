...
:Original: Documentation/userspace-api/media/v4l/vidioc-querycap.rst
...
Tất cả các thiết bị V4L2 đều hỗ trợ ZZ0001ZZ ioctl. Nó được sử dụng để
xác định các thiết bị hạt nhân tương thích với thông số kỹ thuật này và để có được
thông tin về trình điều khiển và khả năng phần cứng. ioctl mất một
con trỏ tới cấu trúc ZZ0000ZZ
được lấp đầy bởi người lái xe. Khi trình điều khiển không tương thích với điều này
đặc điểm kỹ thuật ioctl trả về mã lỗi ZZ0002ZZ.
