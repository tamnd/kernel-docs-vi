...
:Original: Documentation/userspace-api/media/v4l/vidioc-enumaudio.rst
...
VIDIOC_ENUMAUDIO - Liệt kê đầu vào âm thanh
...
Để truy vấn các thuộc tính của ứng dụng đầu vào âm thanh, hãy khởi tạo
...
giới hạn. Để liệt kê tất cả các ứng dụng đầu vào âm thanh sẽ bắt đầu ở chỉ mục
...
EINVAL
    Số lượng đầu vào âm thanh nằm ngoài giới hạn.