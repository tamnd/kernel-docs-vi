...
:Original: Documentation/userspace-api/media/v4l/vidioc-dqevent.rst
...
VIDIOC_DQEVENT - Sự kiện xếp hàng
...
Sắp xếp lại một sự kiện từ thiết bị video. Không cần đầu vào cho việc này
ioctl. Tất cả các trường của cấu trúc ZZ0000ZZ
cấu trúc được lấp đầy bởi người lái xe. Việc xử lý tập tin cũng sẽ nhận được
các trường hợp ngoại lệ mà ứng dụng có thể nhận được, ví dụ: sử dụng hệ thống chọn lọc
gọi.
