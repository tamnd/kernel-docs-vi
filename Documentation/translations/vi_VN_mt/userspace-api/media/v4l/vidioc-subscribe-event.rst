...
:Original: Documentation/userspace-api/media/v4l/vidioc-subscribe-event.rst
...
VIDIOC_SUBSCRIBE_EVENT - VIDIOC_UNSUBSCRIBE_EVENT - Đăng ký hoặc hủy đăng ký sự kiện
...
Đăng ký hoặc hủy đăng ký sự kiện V4L2. Các sự kiện đã đăng ký được loại bỏ bởi
sử dụng ZZ0000ZZ ioctl.
