...
:Original: Documentation/userspace-api/gpio/gpio-get-lineinfo-watch-ioctl.rst
...
GPIO_GET_LINEINFO_WATCH_IOCTL - Cho phép xem một dòng để biết các thay đổi đối với nó
