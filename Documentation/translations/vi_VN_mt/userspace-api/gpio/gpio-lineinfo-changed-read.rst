...
:Original: Documentation/userspace-api/gpio/gpio-lineinfo-changed-read.rst
...
GPIO_LINEINFO_CHANGED_READ - Đọc các sự kiện thay đổi thông tin dòng cho các dòng đã xem
từ con chip.
...
Đọc các sự kiện thay đổi thông tin dòng cho các dòng đã xem từ chip.
...
Một dòng phải được theo dõi bằng gpio-get-lineinfo-watch-ioctl.rst để tạo
