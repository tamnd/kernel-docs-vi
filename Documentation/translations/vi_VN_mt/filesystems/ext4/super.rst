...
:Original: Documentation/filesystems/ext4/super.rst
...
Siêu khối ghi lại nhiều thông tin khác nhau về phần bao bọc
hệ thống tập tin, chẳng hạn như số khối, số lượng inode, các tính năng được hỗ trợ,
thông tin bảo trì, và nhiều hơn nữa.

Nếu cờ tính năng spzzy_super được đặt, các bản sao dư thừa của
mô tả nhóm và siêu khối chỉ được giữ trong các nhóm có nhóm
số là 0 hoặc lũy thừa của 3, 5 hoặc 7. Nếu cờ không được đặt,
bản sao dư thừa được giữ trong tất cả các nhóm.

Tổng kiểm tra siêu khối được tính toán dựa trên cấu trúc siêu khối,
trong đó bao gồm FS UUID.

Siêu khối ext4 được trình bày như sau trong
ZZ0000ZZ:
...
Trạng thái siêu khối là sự kết hợp của các trạng thái sau:
...
Chính sách lỗi siêu khối là một trong những chính sách sau:
...
Người tạo hệ thống tập tin là một trong những người sau đây:
...
Bản sửa đổi siêu khối là một trong những bản sau:
...
Lưu ý rằng ZZ0000ZZ đề cập đến hệ thống tệp sửa đổi 1 hoặc mới hơn.

.. _super_compat:

Trường tính năng tương thích với siêu khối là sự kết hợp của bất kỳ trường nào trong số
sau đây:
...
Trường tính năng không tương thích của siêu khối là sự kết hợp của bất kỳ trường nào trong số
sau đây:
...
Trường tính năng tương thích chỉ đọc siêu khối là sự kết hợp của bất kỳ
sau đây:
...
Trường ZZ0000ZZ là một trong những trường sau:
...
Trường ZZ0000ZZ là bất kỳ sự kết hợp nào sau đây:
...
Danh sách ZZ0000ZZ có thể chứa bất kỳ nội dung nào sau đây:
...
Tổng kích thước của siêu khối là 1024 byte.