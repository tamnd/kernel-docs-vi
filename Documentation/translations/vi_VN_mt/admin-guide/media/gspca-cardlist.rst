...
:Original: Documentation/admin-guide/media/gspca-cardlist.rst
...
Các mô-đun cho trình điều khiển webcam gspca là:

- gspca_main: trình điều khiển chính
- gspca\_\ ZZ0000ZZ: mô-đun trình điều khiển con với ZZ0001ZZ như sau
