...
:Original: Documentation/admin-guide/md.rst
...
Bạn có thể khởi động bằng thiết bị md của mình bằng lệnh kernel sau
dòng:

đối với các mảng đột kích cũ không có siêu khối liên tục::

md=<md số thiết bị>,<mức đột kích>,<hệ số kích thước chunk>,<mức lỗi>,dev0,dev1,...,devn

dành cho mảng đột kích có siêu khối liên tục::

md=<md số thiết bị>,dev0,dev1,...,devn

hoặc, để tập hợp một mảng có thể phân vùng::
