...
:Original: Documentation/scsi/aacraid.rst
...
======================================
Trình điều khiển AACRAID cho Linux (lấy hai cái)
===================================

Giới thiệu
============
Trình điều khiển aacraid bổ sung hỗ trợ cho Adaptec (ZZ0000ZZ
Bộ điều khiển RAID. Đây là một bản viết lại lớn từ bản gốc
Trình điều khiển được cung cấp bởi Adaptec. Nó đã làm sạch đáng kể cả mã
và kích thước nhị phân đang chạy (mô-đun nhỏ hơn một nửa kích thước của
bản gốc).

Thẻ/Chipset được hỗ trợ
========================
...
- cập nhật cho việc thăm dò PCI kiểu mới và đăng ký máy chủ SCSI,
  dọn dẹp/sửa lỗi nhỏ

Matt Domsch <matt_domsch@dell.com>

- sửa đổi ioctl, thông báo bộ điều hợp

Trái phiếu Deanna

- hỗ trợ không phải DASD, sợi PAE và 64 bit, đã thêm bộ điều khiển Adaptec mới
  đã thêm ioctls mới, thay đổi giao diện scsi để sử dụng trình xử lý lỗi mới,
  đã tăng số lượng fibs và các lệnh nổi bật vào vùng chứa
- đã sửa lỗi mô hình bộ nhớ 64bit và 64G, thay đổi quy ước đặt tên khó hiểu
  trong đó các fib đi vào phần cứng luôn được gọi là hw_fibs và
  không chỉ là những sợi như tên của cấu trúc theo dõi trình điều khiển

Đánh dấu Salyzyn <Mark_Salyzyn@adaptec.com>

- Đã khắc phục sự cố hoảng loạn và thêm một số id sản phẩm mới cho hbas sắp tới.
- Điều chỉnh hiệu suất, chuyển đổi dự phòng thẻ và giảm thiểu lỗi.

Achim Leubner <Achim_Leubner@adaptec.com>

- Trình điều khiển gốc
...
nên đừng mong đợi anh ấy sẽ ủng hộ nó.

Adaptec không hỗ trợ trình điều khiển này.  Liên hệ với bộ phận hỗ trợ kỹ thuật của Adaptec hoặc
aacraid@adaptec.com

Bản gốc của Brian Boerner Tháng 2 năm 2001

Viết lại bởi Alan Cox, tháng 11 năm 2001