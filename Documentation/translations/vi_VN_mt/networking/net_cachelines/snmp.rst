...
:Original: Documentation/networking/net_cachelines/snmp.rst
...
===============================================
netns_ipv4 enum phân tích sử dụng đường dẫn nhanh
===========================================

=============== ======================================= ===================== ====================== ======================================================
Loại Tên fastpath_tx_access fastpath_rx_access bình luận
=============== ======================================= ===================== ====================== ======================================================
unsigned_long LINUX_MIB_TCPKEEPALIVE write_chủ yếu là tcp_keepalive_timer
unsigned_long LINUX_MIB_DELAYEDACKS write_chủ yếu là tcp_delack_timer_handler,tcp_delack_timer
unsigned_long LINUX_MIB_DELAYEDACKLOCKED write_chủ yếu là tcp_delack_timer_handler,tcp_delack_timer
unsigned_long LINUX_MIB_TCPAUTOCORKING write_chủ yếu là tcp_push,tcp_sendmsg_locked
...
unsigned_long LINUX_MIB_TCPORIGDATASENT write_chủ yếu là tcp_write_xmit
unsigned_long LINUX_MIB_TCPHPHITS write_mostly tcp_rcv_thành lập,tcp_v4_do_rcv,tcp_v6_do_rcv
unsigned_long LINUX_MIB_TCPRCVCOALESCE write_mostly tcp_try_coalesce,tcp_queue_rcv,tcp_rcv_thành lập
unsigned_long LINUX_MIB_TCPPUREACKS write_chủ yếu là tcp_ack,tcp_rcv_thành lập
unsigned_long LINUX_MIB_TCPHPACKS write_chủ yếu là tcp_ack,tcp_rcv_thành lập
unsigned_long LINUX_MIB_TCPDELIVERED write_mostly tcp_newly_delivered,tcp_ack,tcp_rcv_thành lập
...
không dấu_long LINUX_MIB_PAWS_TW_REJECTED
không dấu_long LINUX_MIB_DELAYEDACKLOST
...
không dấu_long LINUX_MIB_TCPDSACKIGNOREDOLD
unsigned_long LINUX_MIB_TCPDSACKIGNOREDNOUNDO
không dấu_long LINUX_MIB_TCPSPURIOUSRTOS
...
không dấu_long LINUX_MIB_TCPDEFERACCEPTDROP
